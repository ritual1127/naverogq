...
>
> 제출용으로는 **[사업보고서 PDF 50장](docs/CADLens_사업보고서.pdf)** 이 따로 있습니다. 10개 장으로 나눠 표 41개와 그림 13개를 붙인 공문서 형식입니다 ([소개서 원본](docs/CADLens_소개서.html) · [보고서 원본](docs/CADLens_사업보고서.html) · [그래프 만드는 코드](docs/fig/make_figs.py)).
