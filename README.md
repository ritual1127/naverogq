...
>
> 프로젝트 전체를 한 번에 보려면 **[소개서 PDF 20장](docs/CADLens_소개서.pdf)** 을 보세요. 만든 이유부터 정확도 측정, 지표, 한계까지 순서대로 들어 있습니다 ([만든 원본](docs/CADLens_소개서.html) · [그래프 만드는 코드](docs/fig/make_figs.py)).
